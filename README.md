...
To update the database use this command from the Web project folder (replace `BackendAssignment` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../BackendAssignment.Infrastructure/BackendAssignment.Infrastructure.csproj -s BackendAssignment.Web.csproj
```
